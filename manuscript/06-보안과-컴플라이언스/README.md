...
> **시각 보강** ([assets/06-보안과-컴플라이언스/01-korean-law-landscape.svg](../../assets/06-보안과-컴플라이언스/01-korean-law-landscape.svg)): 7개 법령이 "이용자 보호 / 결제·금융 / 거래·표시" 3대 영역에 어떻게 겹치는지 벤다이어그램.
...
> **시각 보강** ([assets/06-보안과-컴플라이언스/02-network-segregation.svg](../../assets/06-보안과-컴플라이언스/02-network-segregation.svg)): 인터넷망 / 업무망 / DB망 3종과 사이의 통제 (방화벽 · 점프 호스트 · DLP) 한 그림.
